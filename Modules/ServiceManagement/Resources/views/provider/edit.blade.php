                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body p-30">
                            <form action="{{route('provider.service.update',[$service->id])}}" method="post"
                                        ...
                                        <div class="table-responsive p-01">
                                            <table class="table align-middle table-variation">
                                                ...
                                                <tbody id="variation-update-table">
                                                    @include('servicemanagement::provider.partials._update-variant-data',['variants'=>$service->variations,'zones'=>$zones])
                                                </tbody>
                                            </table>
                                            ...
                                            <div id="new-variations-table"
                                                ...
                                                <table class="table align-middle table-variation">
                                                    <tbody id="variation-table">
                                                        @include('servicemanagement::provider.partials._variant-data',['zones'=>$zones])
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
