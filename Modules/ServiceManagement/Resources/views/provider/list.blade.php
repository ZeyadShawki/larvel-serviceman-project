            ...
            <div class="row">
                <div class="col-12">
                    <div
                        ...
                        <div>
                            <a href="{{route('provider.service.create')}}" class="btn btn--primary">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="switcher" data-bs-toggle="modal"
                                                            ...
                                                            <input class="switcher_input"
                                                                   onclick="route_alert('{{route('provider.service.status-update',[$service->id])}}','{{translate('want_to_update_status')}}')"
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <a href="{{route('provider.service.edit',[$service->id])}}"
                                                            ...
                                                            <form
                                                                action="{{route('provider.service.destroy',[$service->id])}}"
