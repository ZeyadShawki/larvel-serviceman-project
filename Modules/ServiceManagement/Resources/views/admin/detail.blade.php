...
@endphp @extends('adminmodule::layouts.master') @section('title', translate('service_details')) @push('css_or_js') <link
    rel="stylesheet" href="{{ asset('public/assets/admin-module') }}/plugins/select2/select2.min.css" />
    ...
    <div class="container-fluid">
        ...
        <div class="mb-3">
            <ul class="nav nav--tabs nav--tabs__style2">
                <li class="nav-item">
                    <button class="nav-link {{ !isset($web_page) || $web_page == 'general' ? 'active' : '' }}"
                        data-bs-toggle="tab" data-bs-target="#general-tab-pane">{{ translate('general_info') }}
                    </button>
                </li>
                <li class="nav-item">
                    <button class="nav-link {{ isset($web_page) && $web_page == 'faq' ? 'active' : '' }}"
                        data-bs-toggle="tab" data-bs-target="#faq-tab-pane">{{ translate('faq') }}</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link {{ isset($web_page) && $web_page == 'review' ? 'active' : '' }}"
                            ...
                            <div class="media-body ">
                                <div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
                                    ...
                                    <a href="{{ route('admin.service.edit', [$service->id]) }}"
                                      ...
                                      <h2 style="padding-bottom: 20px;color: #FF69B4;">
                                            {{ $service->email == null
                                                ? 'admin'
                                                : Provider::where('contact_person_email', '=', $service->email)->first()->contact_person_name }}
                                        </h2>
