...
<aside class="aside">
    ...
    <div class="aside-header">
        ...
        <a href="{{ route('admin.dashboard') }}" class="logo d-flex gap-2">
            <img src="{{ asset('storage/app/public/business') }}/{{ $logo->live_values ?? '' }}"
                onerror="this.src='{{ asset('public/assets/placeholder.png') }}'" style="max-height: 50px" alt=""
                class="main-logo">
            <img src="{{ asset('storage/app/public/business') }}/{{ $logo->live_values ?? '' }}"
                onerror="this.src='{{ asset('public/assets/placeholder.png') }}'" style="max-height: 40px"
    ...
    <div class="aside-body" data-trigger="scrollbar">
        <div class="user-profile media gap-3 align-items-center my-3">
            <div class="avatar">
                <img class="avatar-img rounded-circle"
                    ...
                    onerror="this.src='{{ asset('public/assets/provider-module') }}/img/user2x.png'" alt="">
            </div>
        ...
        <ul class="nav">
            ...
            <li>
                <a href="{{ route('provider.service.servicelist') }}"
                    class="{{ request()->is('provider/service/servicelist') ? 'active-menu' : '' }}">
            ...
            <li>
                <a href="{{ route('provider.service.create') }}"
                    class="{{ request()->is('provider/service/create') ? 'active-menu' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('provider.booking.list', ['booking_status' => 'accepted']) }}"
                            ...
                            <span class="link-title">{{ translate('Accepted') }}
                                <span
                                    class="count">{{ $booking->where('booking_status', 'accepted')->count() }}</span>
                            </span>
                        </a>
                    </li>
                    <li>
