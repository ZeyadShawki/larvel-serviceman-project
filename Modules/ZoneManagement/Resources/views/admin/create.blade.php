                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-actions">
                                                        ...
                                                        <button type="button"
                                                            @if (env('APP_ENV') != 'demo') onclick="form_alert('delete-{{ $zone->id }}','{{ translate('want_to_delete_this_zone') }}?')" @endif
...
@push('script')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC52uvc5kD2YvHTPot-yN1HweJ_b3qIGKQ&libraries=drawing,places&v=3.45.8">
    </script>
